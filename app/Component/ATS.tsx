import { cn } from "~/data/fileSize";
import check from "../assets/icons/check.svg";
import warning from "../assets/icons/warning.svg";
import warn from "../assets/icons/ats-warning.svg";
import bad from "../assets/icons/ats-bad.svg";
import good from "../assets/icons/ats-good.svg";
  ...
  return (
    <div
      ...
      <div className="flex flex-row gap-4 items-center">
        <img
          src={score > 69 ? good : score > 49 ? warn : bad}
          alt="ATS"
          className="w-10 h-10"
        />
